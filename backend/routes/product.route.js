...
const { getAllProducts, createProduct, updateProduct, deleteProduct, getProductDetail, createProductReview, getProductReviews, deleteReview } = require("../controllers/product.controller");
...
router.route("/reviews").get(getProductReviews).delete(isAuthenticated, asyncHandler(deleteReview));
