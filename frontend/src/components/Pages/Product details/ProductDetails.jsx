...
function ProductDetails() {
  ...
  return (
    <div className="h-screen max-w-[80%] mx-auto p-2 my-4 flex mt-[5%] justify-between">
      <div className="mx-4 w-5/12 border-white border">
      ...
      <div className="w-[70%] mx-4 border px-5 py-6 border-white">
          ...
          {/* Details block - 3*/}
              <div className=" my-3 border-b border-b-gray-400 pb-3">
                  ...
                  <div className="flex items-center gap-4 border-b border-b-gray-400 pb-3">
                      <div className="py-2">
                          <button className="text-lg font-bold bg-red-500 hover:bg-green-600 text-white px-2 py-1">-</button>
                          <input type="number" value={1} className="px-4 py-2 text-center w-20 border-none outline-none"  />
                          <button className="text-lg font-bold bg-red-500 hover:bg-green-600 text-white px-2 py-1">+</button>
                      </div>
                      <button className="bg-red-500 rounded-3xl px-6 hover:bg-red-600 py-2 text-sm text-white font-semibold">Add to Cart</button>
                  </div>
          ...
          {/* Details block - 4 */}
              ...
              <button className="bg-red-500 rounded-3xl px-6 hover:bg-red-600 hover:scale-105 py-2 text-sm text-white font-semibold">Submit Review</button>
      </div>
    </div>
  );
}
